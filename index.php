...
$title = "Académicos FAU";
$description = "Este es el cuerpo académico de la Facultad de Arquitectura y Urbanismo de la Universidad de Chile.";
?>
<head>
<meta charset="utf-8">
...
<h2>Académicos por Categoría<h2>

<img src="images/cat_acade-01.png" class="img-responsive">

<h2>Horas de trabajo de Académicos<h2>
<img src="images/horas_doc.png" class="img-responsive">

<h2>Proyectos de investigación, memorias y publicaciones-Profesores Asociados (Eduardo Castillo y Mauricio Vico) <h2>
  <h5>Proyectos de Investigación<h5>
<img src="images/proy_inv01.png" class="img-responsive">
<h5>Memorias y Tesis<h5>
<img src="images/proy_mem01.png" class="img-responsive">
<h5>Publicaciones<h5>
<img src="images/proy_publi01.png" class="img-responsive">
</ol>
<p>Pero si reducimos el listado recién presentado a los que "han demostrado una actividad académica sostenida, capacidad y aptitudes para realizarla en forma autónoma y creativa y dominio de su especialidad",
 sólo tenemos:</p>
<ol>
<?php
for ($d = 0; $d < $all; $d++) {
...
<p>Los profesores que "han demostrado una actividad docente sostenida, realizándola en forma autónoma y creativa, con pleno dominio de su especialidad,
dando a conocer su experiencia en textos de uso docente", serían:</p>
<ol>
<?php
for ($d = 0; $d < $all; $d++) {
